...
FORCE_DISABLE_BF16 = os.getenv("COMFY_DISABLE_BF16", "1") != "0"
if FORCE_DISABLE_BF16:
    logging.info("Disabling bfloat16 to avoid InstantID NaNs (set COMFY_DISABLE_BF16=0 to re-enable).")
